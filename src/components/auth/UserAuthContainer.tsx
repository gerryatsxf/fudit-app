...
const UserAuthContainer: React.FC<any> = () => {
  ...
  const [passwordError, setPasswordError] = useState(isValidPassword(password) || isEmptyPassword(password) ? "" : "Password must be at least 6 characters");
  ...
  return (
      <AuthContext.Provider value={{email, password, emailError, passwordError, isValidEmail, isEmptyEmail, isValidPassword, isEmptyPassword, setEmail, setPassword, setEmailError, setPasswordError}}>
          <RegisterContext.Provider value={{firstName, firstNameError, lastName, lastNameError, isEmptyName, isValidName, setFirstName, setFirstNameError, setLastName, setLastNameError}}>
